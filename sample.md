...
Microsoft Office Word или OpenOffice Writer. (стиль: ispText_main)
...
-   информация об авторах/Information about authors. (стиль: ispList)
...
## 2.3 Поля {#поля .ispSubHeader-3-level}
...
## 2.7 Формулы {#формулы .ispSubHeader-3-level}
...
-   Для электронных ресурсов в Интернет --- фамилии и инициалы всех
    ...
    публикации или создания) (стиль: ispList).
